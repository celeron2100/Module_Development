...
class GetAllFrontendDispatchsTest extends TestCase
{
     ...
     * @return void
     */
    public function testGetAllFrontendDispatchs()
    {
        // 創建一個使用者
        ...
        // 取得全部前台派遣，並設定 Bearer Token
        $response = $this->withToken($access_token)->get('/api/frontend/dispatchs');

...
class DeleteOneFrontendDispatchsTest extends TestCase
{
     ...
     * @return void
     */
    public function testDeleteOneFrontendDispatchs()
    {
        // 創建一個使用者
        ...
        // 刪除單一前台派遣，並設定 Bearer Token
        $response = $this->withToken($access_token)->delete('/api/frontend/dispatchs/1');

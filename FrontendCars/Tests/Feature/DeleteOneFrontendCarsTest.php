...
class DeleteOneFrontendCarsTest extends TestCase
{
     ...
     * @return void
     */
    public function testDeleteOneFrontendCars()
    {
        // 創建一個使用者
        ...
        // 刪除車輛
        $response = $this->withToken($access_token)->delete('/api/frontend/car/1');

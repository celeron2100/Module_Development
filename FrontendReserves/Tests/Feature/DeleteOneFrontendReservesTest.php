...
class DeleteOneFrontendReservesTest extends TestCase
{
     ...
     * @return void
     */
    public function testDeleteOneFrontendReserves()
    {
        // 創建一個使用者
        ...
        // 刪除新增的預約
        $response = $this->withToken($access_token)->delete('/api/frontend/reserves/1');

...
class GetAllFrontendReservesTest extends TestCase
{
     ...
     * @return void
     */
    public function testGetAllFrontendReserves()
    {
        // 創建一個使用者
        ...
        // 取得所有預約
        $response = $this->withToken($access_token)->get('/api/frontend/reserves');

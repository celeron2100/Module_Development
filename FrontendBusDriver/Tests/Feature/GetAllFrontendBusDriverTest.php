...
class GetAllFrontendBusDriverTest extends TestCase
{
     ...
     * @return void
     */
    public function testGetAllFrontendBusDriver()
    {
        // 創建一個使用者
        ...
        // 取得全部前台司機，並設定 Bearer Token
        $response = $this->withToken($access_token)->get('/api/frontend/bus-driver');
